...
public class pillar_three : MonoBehaviour
{
    public int pillarHP = 100; // The health of the pillar
    public int innerDamageMultiplier = 6; // Damage multiplier for inner zone
    ...
    public float innerZoneRadius = 20.0f;
    public float outerZoneRadius = 35.0f;
    ...
    private void Update()
    {
        ...
        if (player != null)
        {
            ...
            player.SendMessage("ReceivePillarThreeHP", pillarHP);
        }
    }
